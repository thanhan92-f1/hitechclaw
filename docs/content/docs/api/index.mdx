...
description: Complete REST API endpoints for the HiTechClaw server.
---

HiTechClaw exposes a REST API for managing agents, skills, workflows, and memory. The server runs on port `18789` by default.
