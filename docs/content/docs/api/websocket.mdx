...
xClaw uses WebSocket for real-time communication between the server and clients. The server bridges internal EventBus events to connected WebSocket clients.
...
ws.onopen = () => {
  console.log('Connected to xClaw');
