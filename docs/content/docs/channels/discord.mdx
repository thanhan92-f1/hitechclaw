---
title: Discord
description: Connect a Discord Bot to xClaw for real-time AI conversations in your server.
---
...
2. Click **New Application**, enter a name (e.g., "xClaw Bot")
...
Click **Activate** on the channel card. xClaw will connect via the Discord Gateway WebSocket.
