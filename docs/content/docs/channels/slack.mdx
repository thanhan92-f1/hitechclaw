---
title: Slack
description: Connect xClaw to your Slack workspace for AI-powered team assistance.
---
...
2. Choose **From scratch**, name it (e.g., "xClaw AI"), select your workspace
...
2. Set **Request URL** to your xClaw webhook: `https://your-domain/api/channels/slack/events`
